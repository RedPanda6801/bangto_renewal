...
public class OptionController {
    ...
    // 옵션 추가
    @PostMapping(path = "/seller/option", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    // 옵션 수정
    @PutMapping(path = "/seller/option", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
